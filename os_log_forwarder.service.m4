...
[Service]
ExecStart=/bin/sh -c "journalctl -o short -f | ncat --idle-timeout LOG_FORWARDER_TIMEOUT --wait LOG_FORWARDER_CONNECT_TIMEOUT --ssl LOG_FORWARDER_SYSLOG_HOST LOG_FORWARDER_SYSLOG_PORT"
Restart=on-failure
TimeoutSec=300
RestartSec=10
